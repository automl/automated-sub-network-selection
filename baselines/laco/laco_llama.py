...
tasks = "winogrande,hellaswag,arc_challenge,piqa,lambada_openai,gsm8k,mmlu,boolq,truthfulqa_mc2"
metric_map = {
    "winogrande": "acc,none",
...
for t in tasks:
    ...
    with open(f"laco_{args.merge_layers}_{args.threshold}.pkl", "wb") as f:
